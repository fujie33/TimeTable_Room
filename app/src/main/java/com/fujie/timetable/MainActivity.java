...
import com.fujie.timetable.db.DatabaseHelper;
import com.fujie.timetable.db.Repo;
import com.fujie.timetable.db.room.model.Course;
import com.fujie.timetable.model.CourseMode;
import com.fujie.timetable.model.CourseTimeMode;
import com.fujie.timetable.view.AddCourseDialog;
import com.fujie.timetable.view.AddCourseTimeDialog;
import com.fujie.timetable.view.MessageDialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        layoutCourseNumber = findViewById(R.id.layout_course_number);
        repo = new Repo(this);
    }
    ...
    private void createCourseInfoView(final CourseMode course) {
        ...
        if ((integer < 1 && integer > 7) || course.getStart() > course.getEnd()) {
            ...
            switch (index) {
                case 0:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorRed));
                    break;
                case 1:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorOrange));
                    break;
                case 2:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorYellow));
                    break;
                case 3:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorGreen));
                    break;
                case 4:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorCyan));
                    break;
                case 5:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorBlue));
                    break;
                case 6:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorPurple));
                    break;
                case 7:
                    tvCourseInfo.setBackgroundColor(this.getResources().getColor(R.color.colorScarlet));
                    break;
            }
     ...
     * @param courseMode
     */
    private boolean saveData(CourseMode courseMode) {
//        SQLiteDatabase sqLiteDatabase =  databaseHelper.getWritableDatabase();
...
//        values.put("end", course.getEnd());
        ...
        Course course = new Course(
                courseMode.getCourseName(),
                courseMode.getTeacher(),
                courseMode.getClassRoom(),
                courseMode.getDay(),
                courseMode.getStart(),
                courseMode.getEnd()
        );
//        long rowid = sqLiteDatabase.insert("course", null, values);//返回新添记录的行号，与主键id无关
        repo.InsertCourse(course);//返回新添记录的行号，与主键id无关
        return true;
    }
